...
const Home = () => {
  ...
  return (
    <React.Fragment>
      <Header />
      <h2>How to invest and trade in real estate with GoldenCity?</h2>
      ...
      <h3>
        How <span className="cl-blue">GoldenCity</span> works?
      </h3>
      <div className="how">
        ...
        <img
          src={vrmobile}
          className="vrmobile"
          alt="GoldenCity mobile"
          style={{ width: "550px", height: "350px", objectFit: "contain" }}
        />
      </div>
